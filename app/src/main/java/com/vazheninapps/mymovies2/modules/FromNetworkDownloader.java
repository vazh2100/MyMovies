...
public class FromNetworkDownloader {
    ...
    //values
    private static final String API_KEY = "1b4c24903b2160c8730bfe78cfbbfc5b";
    ...
    private static URL buildURLToVideos(int movieId, String lang) {
    ...
    private static URL buildURLToReviews(int movieId, String lang) {
